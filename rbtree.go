...
// Item is the object stored in each tree node. It
// must be Serializable via greenpack.
type Item msgp.Serz
...
type TreeSerz struct {
	Elslice []Item `msg:",iface" zid:"0"`
}
...
func (s *Tree) PostLoadHook() {
	...
	s.Serz = nil // finally we can release the Serz memory
}
